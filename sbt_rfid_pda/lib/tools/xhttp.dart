...
import 'package:sbt_rfid_pda/config/helper.dart';
import 'package:sbt_rfid_pda/tools/logger.dart';
import 'package:sbt_rfid_pda/tools/toast.dart';
...
class XHttp {
  ...
  String _getBaseUrl() => Helper.getApiUrl();
...
void logWrapped(String text) {
  ...
  pattern.allMatches(text).forEach((match) => Logger.logInfo(match.group(0)));
}
